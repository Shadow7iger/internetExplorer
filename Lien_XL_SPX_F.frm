VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Lien_XL_SPX_F 
   Caption         =   "Activate the link to the Excel estimate - MRS Word"
   ClientHeight    =   7620
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   6375
   OleObjectBlob   =   "Lien_XL_SPX_F.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "Lien_XL_SPX_F"
